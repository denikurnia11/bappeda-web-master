    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="h6 modal-title">Tambah Data Kategori</h2>
            ...
            <form action="" method="post" id="form-tambah">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kategori" placeholder="Masukkan kategori..." name="kategori" required autocomplete="off">
                    </div>
