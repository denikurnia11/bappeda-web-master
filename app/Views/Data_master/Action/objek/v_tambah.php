    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="h6 modal-title">Tambah Data Objek</h2>
            ...
            <form action="" method="post" id="form-tambah">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="objek" placeholder="Masukkan objek..." name="objek" required autocomplete="off">
                    </div>
                    <div class="mb-3">
